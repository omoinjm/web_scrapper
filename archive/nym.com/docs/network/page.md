...
URL Source: https://nym.com/docs/network
...
## Technical Motivations for Nym[](https://nym.com/docs/network#technical-motivations-for-nym)
...
## Mixnet TL;DR[](https://nym.com/docs/network#mixnet-tldr)
...
[Core Concepts](https://nym.com/docs/network/concepts "Core Concepts")
